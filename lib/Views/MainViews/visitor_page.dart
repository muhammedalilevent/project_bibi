          ...
          Expanded(
            child: Container(
              ...
              child: TabBarView(
                ...
                children: <Widget>[getMyBibi(), getMyAnswers(), getMyBibi()],
              ),
            ),
          )
        ],
          ...
          return InkWell(
            onTap: () {
              Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => BibiDetailPage()));
            },
            child: Card(
                      ...
                      children: <Widget>[
                        Padding(
                          padding: const EdgeInsets.only(
                              top: 10, left: 10, bottom: 10, right: 3),
                          child: CircleAvatar(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              Image.asset(
                                "assets/images/questions_answer_icon/answer.png",
                                height: 25,
                                width: 25,
                              ),
                              SizedBox(
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              Image.asset(
                                "assets/images/questions_answer_icon/like.png",
                                height: 25,
                                width: 25,
                              ),
                              ...
                              Image.asset(
                                "assets/images/questions_answer_icon/dislike.png",
                                height: 25,
                                width: 25,
                              ),
                              SizedBox(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          Image.asset(
                            "assets/images/questions_answer_icon/comment.png",
                            height: 25,
                            width: 25,
                          ),
                          SizedBox(
          ...
          return Dialog(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Kendinizi Bir Cümle İle Anlatınız",
                  ),
                  SizedBox(
                    height: 15,
                  ),
